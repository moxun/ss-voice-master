...
public class FindChildDetailsAdapter extends BaseMultiItemQuickAdapter<FindBean, FindChildDetailsAdapter.BaseViewholder> {
...
//                    careIv.setVisibility(View.GONE);
//                    onFindItemOprateListener.onCare(String.valueOf(bean.getUser_id()));
                }
            });
            ...
            talkIv.setOnClickListener(v -> {
                if (onFindItemOprateListener != null){
                    ...
                    onFindItemOprateListener.onReply(bean.getId());
                }
            });
