...
import com.miaomi.fenbei.base.widget.soulplanets.PlanetAdapter;
import com.miaomi.fenbei.base.widget.soulplanets.PlanetView;

import java.io.UnsupportedEncodingException;
import java.util.Random;


public class MatchUserAdapter extends PlanetAdapter {
    ...
    public View getView(Context context, int position, ViewGroup parent) {
        ...
        int starWidth = DensityUtil.INSTANCE.dp2px(context, 50.0f);
        int starHeight = DensityUtil.INSTANCE.dp2px(context, 85.0f);
        int starPaddingTop = DensityUtil.INSTANCE.dp2px(context, 20.0f);
