...
public class AddPartAdapter extends RecyclerView.Adapter<AddPartAdapter.ItemHodler> {
    private Context context;
    private List<DividedUserBean.ListBean> list = new ArrayList<>();
    private CheckItemListener mCheckListener;
    public AddPartAdapter(Context context, CheckItemListener mCheckListener) {
    ...
    public ItemHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ItemHodler(LayoutInflater.from(context).inflate(R.layout.item_family_add_part_member, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AddPartAdapter.ItemHodler holder, final int position) {
