 ...
 * on 2019-08-22.
 */
class MicOperateRadioDialog (bean: UserInfo): BaseBottomDialog() {
...
//        var bean = arguments!!.getParcelable("data") as UserInfo
    ...
    fun setOnMicOperateClickListener(onMicOperateClickListener: OnMicOperateClickListener): MicOperateRadioDialog {
