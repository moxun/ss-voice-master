 ...
 * on 2019-08-22.
 */
class XqMicOperateDialog (bean: UserInfo): BaseBottomDialog() {
...
//        }
    ...
    override fun bindView(v: View) {
        ...
        v.clear_btn.visibility=View.GONE
...
//        var bean = arguments!!.getParcelable("data") as UserInfo
    ...
    fun setOnMicOperateClickListener(onMicOperateClickListener: OnMicOperateClickListener): XqMicOperateDialog {
