...
public class FemaleMeetLayoutManager extends LinearLayoutManager implements RecyclerView.OnChildAttachStateChangeListener{
    //判断是否上滑还是下滑
    private int mDrift;
    ...
    public FemaleMeetLayoutManager(Context context, int orientation, boolean reverseLayout) {
