...
public class CircularProgressButton extends ImageButton {
    ...
    public void setProgressTotal(int mProgressTotal) {
        this.mProgressTotal = mProgressTotal;
    }
    ...
    public CircularProgressButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressButton_backWidth, 10));
        mBackPaint.setColor(typedArray.getColor(R.styleable.CircularProgressButton_backColor, Color.LTGRAY));
        ...
        mProgPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressButton_progWidth, 10));
        mProgPaint.setColor(typedArray.getColor(R.styleable.CircularProgressButton_progColor, Color.BLUE));

        // 初始化进度圆环渐变色
        int startColor = typedArray.getColor(R.styleable.CircularProgressButton_progStartColor, -1);
        int firstColor = typedArray.getColor(R.styleable.CircularProgressButton_progFirstColor, -1);
        if (startColor != -1 && firstColor != -1) mColorArray = new int[]{startColor, firstColor};
        else mColorArray = null;

        // 初始化进度
        mProgress = typedArray.getInteger(R.styleable.CircularProgressButton_progress, 0);
        typedArray.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, 275, 360 * mProgress / mProgressTotal, false, mProgPaint);
    }
