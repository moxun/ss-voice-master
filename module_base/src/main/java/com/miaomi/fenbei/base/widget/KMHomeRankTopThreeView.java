...
public class KMHomeRankTopThreeView extends FrameLayout {
    ...
    public KMHomeRankTopThreeView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public KMHomeRankTopThreeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public KMHomeRankTopThreeView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.common_home_rank_top_three, this,true);
