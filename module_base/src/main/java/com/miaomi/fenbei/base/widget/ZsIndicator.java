...
public class ZsIndicator extends View implements IPagerIndicator {
    ...
    private int mMode = MODE_EXACTLY;  // 默认为MODE_MATCH_EDGE模式
    ...
    public ZsIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ZsIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init(){
//        setImageResource(R.drawable.room_bg_zs_indicator_selected);
    }

    @Override
    protected void onDraw(Canvas canvas) {
//        canvas.dr(mLineRect, mRoundRadius, mRoundRadius, mPaint);
    }
