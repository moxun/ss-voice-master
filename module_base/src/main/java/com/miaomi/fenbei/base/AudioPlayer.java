...
public class AudioPlayer {
    ...
    public static String RECORD_DIR = CommonLib.mContext.getFilesDir().getPath()+"/record/";
        ...
        try {
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    ToastUtil.INSTANCE.suc(CommonLib.mContext,"已达到最大语音长度");
                }
    ...
    public void startRecord(Callback callback, int time) {
        mRecordCallback = callback;
        try {
            mAudioRecordPath = CURRENT_RECORD_FILE + System.currentTimeMillis() + ".m4a";
            mRecorder = new MediaRecorder();
...
//            ToastUtil.suc("语音文件已损坏或不存在");
     ...
     * 打开assets下的音乐mp3文件
     */
    public void openAssetMusics(Context context, String name) {
