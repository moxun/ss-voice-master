...
public class KMXBRankIndicator  extends MagicIndicator {
    private Context mContext;
    private String[] tabNames = new String[]{"今日", "昨日","周榜"};
    private String indicatorColor = "#FFFFFF";
    private String clipColor = "#FD7F8F";
    private String textColor = "#FFFFFF";
    public KMXBRankIndicator(Context context) {
        super(context);
        this.mContext = context;
    }

    public KMXBRankIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }
...
//                simplePagerTitleView.setWidth(DensityUtil.INSTANCE.dp2px(context,100f));
                ...
                simplePagerTitleView.setSelectedColor(Color.parseColor("#F96C35"));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setColors(Color.parseColor("#F96C35"));
                return indicator;
            }
        };
