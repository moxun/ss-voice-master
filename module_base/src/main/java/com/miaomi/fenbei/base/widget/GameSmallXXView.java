...
//            ,"九九安康","十全十美","十一而税","十二金钗","十三太保"};
    ...
    public GameSmallXXView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }

    public GameSmallXXView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        init();
    }
    private void init(){
        View view = LayoutInflater.from(mContext).inflate(R.layout.base_layout_game_xx_small,this,true);
