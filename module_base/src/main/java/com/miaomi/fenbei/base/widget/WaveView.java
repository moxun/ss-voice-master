...
public class WaveView extends View {
    ...
    public void setStroke() {
        ...
        mPaint.setStrokeWidth(DensityUtil.INSTANCE.dp2px(getContext(),2f));
    }
    ...
    private class Circle {
        ...
        public int getAlpha() {
            float percent = (System.currentTimeMillis() - mCreateTime) * 0.4f / mDuration;
            return (int) ((1.0f - mInterpolator.getInterpolation(percent)) * 255+0.3f);
        }
