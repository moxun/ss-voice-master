...
public class KMArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
...
//        }
     ...
     * @param attrs
     */
    public KMArrowRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
...
//    }
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.common_listview_header1, null);
...
//        loadingIv.setImageResource(R.drawable.anim_loading);
        mVolumeAnim = (AnimationDrawable) mArrowImageView.getDrawable();
//        mVolumeAnim.start();
