...
public class MicSeatView extends FrameLayout {
    ...
    public MicSeatView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.view_mic_seat, this, true);
    ...
    public void loadDrawble(int drawbleRes) {
        ImgUtil.INSTANCE.loadImg(mContext, drawbleRes, mMicSeat1);
    }
