...
public class DCBTextView  extends androidx.appcompat.widget.AppCompatTextView {
    public DCBTextView(Context context) {
        this(context, null);
    }
    public DCBTextView(Context context, @Nullable AttributeSet attrs) {
        this(context,attrs,0);
    }
    public DCBTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
